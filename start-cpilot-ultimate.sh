...
# 终极修复版本的 cPilot_v1 启动脚本

echo "🚀 启动终极修复版本的 cPilot_v1 后端服务..."
...
# 安装基础依赖
echo "📦 安装基础依赖..."
pip install colorama requests_oauthlib sqlalchemy
...
python -c "import sqlalchemy; print('✅ sqlalchemy: OK')" || echo "❌ sqlalchemy: 安装失败"
